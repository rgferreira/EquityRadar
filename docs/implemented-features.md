...
- Phase 3.9 operational acceptance: prospective post-promotion monitoring, all-page synthetic AppTest regression coverage, provider-health diagnostics, server-lifetime scheduled refresh, verified daily SQLite backups, persisted research alerts, options-continuity gates, and a non-executing allocation Scenario lab.
