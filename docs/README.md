...
| [`releases/phase-3.9/PROMOTION-2026-07-14.md`](releases/phase-3.9/PROMOTION-2026-07-14.md) | Immutable coverage-aware live-model promotion and rollback record | Current release note |
